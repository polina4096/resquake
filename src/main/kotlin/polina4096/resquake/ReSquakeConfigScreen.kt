...
fun generateConfigScreen(parent: Screen?)
    = YetAnotherConfigLib.createBuilder()
        ...
        .category(
            ...
            .group(
                ...
                .collapsed(false)
                .option(
                    Option.createBuilder(Boolean::class.javaPrimitiveType)
            ...
            .group(
                ...
                .option(
                    Option.createBuilder(Double::class.javaPrimitiveType)
                ...
                .option(
                    Option.createBuilder(Color::class.javaPrimitiveType)
